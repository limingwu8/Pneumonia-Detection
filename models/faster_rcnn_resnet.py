...
def decom_resnet50():
    ...
    features = [model.conv1, model.bn1, model.relu, model.maxpool,
                list(model.layer1)[0], list(model.layer1)[1], list(model.layer1)[2],
                list(model.layer2)[0], list(model.layer2)[1], list(model.layer2)[2], list(model.layer2)[3],
                list(model.layer3)[0], list(model.layer3)[1], list(model.layer3)[2], list(model.layer3)[3],
                list(model.layer3)[4], list(model.layer3)[5]]

    features.append(nn.Conv2d(1024, 512, 3, 1, 1))
...
class FasterRCNNResNet50(FasterRCNN):
    ...
    def __init__(self,
        ...
        _, classifier = decom_vgg16()
        extractor = decom_resnet50()
